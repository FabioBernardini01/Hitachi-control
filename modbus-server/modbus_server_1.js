...
const modbusServerHost = process.env.MODBUS_SERVERHOST_1 || '0.0.0.0';
const modbusPort = process.env.MODBUS_1_PORT;
...
// --- LOGICA WARNING RANDOMICO (simula warning non legato all'inchiostro) ---
// Warning randomico
